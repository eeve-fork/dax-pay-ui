<template>
  <div>
    ...
    <WechatReceiverBindEdit ref="alipayReceiverBindEdit" @ok="queryPage" />
  </div>
</template>

<script lang="ts" setup>
  import { computed, onMounted, ref } from 'vue'
  import { del, page, bind, unbind } from './WechatReceiverBind.api'
  ...
  import WechatReceiverBindEdit from './WechatReceiverBindEdit.vue'
  import { useDict } from '@/hooks/bootx/useDict'
  import { AllocRelationTypeEnum } from '@/enums/daxpay/daxpayEnum'
  import AlipayReceiverBindEdit
    from '@/views/daxpay/common/channel/alipay/receiver/bind/AlipayReceiverBindEdit.vue'
